...
DATA_TILES:	;This is the data for the tiles not regularly uploaded by SMW
	...
	db $FC,%00111000		;>(02, 00)
	db $FC,%00111000		;>(03, 00)
	db $FC,%00111000		;>(04, 00)
	db $FC,%00111000		;>(05, 00)
	db $FC,%00111000		;>(06, 00)
	db $FC,%00111000		;>(07, 00)
	db $FC,%00111000		;>(08, 00)
	db $FC,%00111000		;>(09, 00)
	db $FC,%00111000		;>(10, 00)
	db $FC,%00111000		;>(11, 00)
	db $FC,%00111000		;>(12, 00)
	db $FC,%00111000		;>(13, 00)
	db $FC,%00111000		;>(14, 00)
	db $FC,%00111000		;>(15, 00)
	db $FC,%00111000		;>(16, 00)
	db $FC,%00111000		;>(17, 00)
	db $FC,%00111000		;>(18, 00)
	db $FC,%00111000		;>(19, 00)
	db $FC,%00111000		;>(20, 00)
	db $FC,%00111000		;>(21, 00)
	db $FC,%00111000		;>(22, 00)
	db $FC,%00111000		;>(23, 00)
	db $FC,%00111000		;>(24, 00)
	db $FC,%00111000		;>(25, 00)
	db $FC,%00111000		;>(26, 00)
	db $FC,%00111000		;>(27, 00)
	db $FC,%00111000		;>(28, 00)
	db $FC,%00111000		;>(29, 00)
	db $FC,%00111000		;>(30, 00)
	db $FC,%00111000		;>(31, 00)

DATA_TILES2:
	;Start of second line, the first 14 8x8 spaces on second row.
	db $FC,%00111000		;>(00, 01)
	db $FC,%00111000		;>(01, 01)
	db $FC,%00111000		;>(02, 01)
	db $FC,%00111000		;>(03, 01)
	db $FC,%00111000		;>(04, 01)
	db $FC,%00111000		;>(05, 01)
	db $FC,%00111000		;>(06, 01)
	db $FC,%00111000		;>(07, 01)
	db $FC,%00111000		;>(08, 01)
	db $FC,%00111000		;>(09, 01)
	db $FC,%00111000		;>(10, 01)
	db $FC,%00111000		;>(11, 01)
	db $FC,%00111000		;>(12, 01)
	db $FC,%00111000		;>(13, 01)
	;
...
DATA_TILES3:
	...
	db $FC,%00111000		;>(18, 01)
	db $FC,%00111000		;>(19, 01)
	db $FC,%00111000		;>(20, 01)
	db $FC,%00111000		;>(21, 01)
	db $FC,%00111000		;>(22, 01)
	db $FC,%00111000		;>(23, 01)
	db $FC,%00111000		;>(24, 01)
	db $FC,%00111000		;>(25, 01)
	db $FC,%00111000		;>(26, 01)
	db $FC,%00111000		;>(27, 01)
	db $FC,%00111000		;>(28, 01)
	db $FC,%00111000		;>(29, 01)
	db $FC,%00111000		;>(30, 01)
	db $FC,%00111000		;>(31, 01)
DATA_TILES4:
	; two tiles at the upper middle left
	; Third line, the first two 8x8 spaces (two tiles left from the NAME text).
	db $FC,%00111000		;>(00, 02)
	db $FC,%00111000		;>(01, 02)
DATA_TILES5:
	...
	db $FC,%00111000		;(30, 02)
	db $FC,%00111000		;(31, 02)
DATA_TILES6:
	; three tiles at the lower middle left
	; Fourth line, the first 3 8x8 spaces before the "X" symbol and lives counter.
	db $FC,%00111000		;>(00, 03)
	db $FC,%00111000		;>(01, 03)
	db $FC,%00111000		;>(02, 03)
DATA_TILES7:
	; two tiles at the lower middle right
	; Fourth line, the last two 8x8 spaces after the last 0 on the score counter.
	db $FC,%00111000		;>(30, 03)
	db $FC,%00111000		;>(31, 03)
DATA_TILES8:
	; bottom row
	; Fifth line, the first 14 8x8 spaces.
	db $FC,%00111000		;>(00, 04)
	db $FC,%00111000		;>(01, 04)
	db $FC,%00111000		;>(02, 04)
	db $FC,%00111000		;>(03, 04)
	db $FC,%00111000		;>(04, 04)
	db $FC,%00111000		;>(05, 04)
	db $FC,%00111000		;>(06, 04)
	db $FC,%00111000		;>(07, 04)
	db $FC,%00111000		;>(08, 04)
	db $FC,%00111000		;>(09, 04)
	db $FC,%00111000		;>(10, 04)
	db $FC,%00111000		;>(11, 04)
	db $FC,%00111000		;>(12, 04)
	db $FC,%00111000		;>(13, 04)
	;
	; Item box would be here. Already DMA'd in SMW's regular code
	; Not included here for compatibility with the status bar editor tool
	;
DATA_TILES9:
	...
	db $FC,%00111000		;>(18, 04)
	db $FC,%00111000		;>(19, 04)
	db $FC,%00111000		;>(20, 04)
	db $FC,%00111000		;>(21, 04)
	db $FC,%00111000		;>(22, 04)
	db $FC,%00111000		;>(23, 04)
	db $FC,%00111000		;>(24, 04)
	db $FC,%00111000		;>(25, 04)
	db $FC,%00111000		;>(26, 04)
	db $FC,%00111000		;>(27, 04)
	db $FC,%00111000		;>(28, 04)
	db $FC,%00111000		;>(29, 04)
...
UPLOAD_STATBAR9:
	...
	BPL UPLOAD_STATBAR9
      	...
      	LDA #!Setting_SuperStatusBar_Time_CountdownSpeed		; Recover old code
...
MAIN:	PHB
	...
	if !Setting_SuperStatusBar_Time_LowWarning != 0
	...
	CMP #!Setting_SuperStatusBar_Time_CountdownSpeed	;|
	BNE no_warning_sound					;/
...
CODE_008E26:		BEQ CODE_008E6F_OR_008E95		;/
	if !Setting_SuperStatusBar_Time_Enable != 0 ;>begin timer routine.
...
CODE_008E2D:		LDA #!Setting_SuperStatusBar_Time_CountdownSpeed	;\Another timer frame counter?
...
CODE_008E72:		STA !Setting_SuperStatusBar_Time_XYToAddress	;| 
CODE_008E75:		LDA $0F32|!addr		;|
CODE_008E78:		STA !Setting_SuperStatusBar_Time_XYToAddress+2	;| 
CODE_008E7B:		LDA $0F33|!addr		;| 
CODE_008E7E:		STA !Setting_SuperStatusBar_Time_XYToAddress+4	;/
...
CODE_008E8A:		LDA #$FC			;|
CODE_008E8C:		STA !Setting_SuperStatusBar_Time_XYToAddress,X	;/
...
CODE_008E95_IF_THEN:
	if !Setting_SuperStatusBar_Score_Enable != 0 ;>begin score
CODE_008E95:		LDX #$03		
...
CODE_008EDE:		LDX #$00				;\  
CODE_008EE0:		LDA !Setting_SuperStatusBar_Score_XYToAddress,X		;| 
CODE_008EE3:		BNE CODE_008EEF				;|

CODE_008EE5:		LDA #$FC				;|Replace all leading zeroes in the score with spaces 
CODE_008EE7:		STA !Setting_SuperStatusBar_Score_XYToAddress,X		;|
...
CODE_008F05:		LDX #$00		
CODE_008F07:		LDY #$00
	if !Setting_SuperStatusBar_Score_Enable != 0					;\Somehow asar is complaining me that the subroutine
...
CODE_008F0C:		LDX #$00				;\  
CODE_008F0E:		LDA !Setting_SuperStatusBar_Score_XYToAddress,X	     	;| 
CODE_008F11:		BNE CODE_008F1D_IF_THEN	   		;|
CODE_008F13:		LDA #$FC				;|Replace all leading zeroes in the score with spaces 
CODE_008F15:		STA !Setting_SuperStatusBar_Score_XYToAddress,X	     	;|
...
;--------------------------------------------------------------------
CODE_008F1D_IF_THEN:
	if !Setting_SuperStatusBar_Coins_Enable != 0 ;begin coin routine.
...
CODE_008F3B_IF_THEN:
	if !Setting_SuperStatusBar_Lives_Enable != 0 ;>begin lives
...
CODE_008F58:		STA !Setting_SuperStatusBar_Lives_XYToAddress+2	       	;/
CODE_008F50:		TXA		       			;\  
CODE_008F51:		BNE CODE_008F55	   			;|If 10s is 0, replace with space 
CODE_008F53:		LDA #$FC				;|
CODE_008F55:		STA !Setting_SuperStatusBar_Lives_XYToAddress	      	;> Write lives to status bar.
	endif ;>end of lives

	if !Setting_SuperStatusBar_BonusStars_Enable != 0 ;>begin bonus stars
...
CODE_008F73_IF_THEN:
	if !Setting_SuperStatusBar_Coins_Enable != 0 ;>begin coins 2
...
CODE_008FC5:		JSL $009079   ; Draw item box item sprite  
			PHK
			PLB
	if !Setting_SuperStatusBar_PlayerName_Enable != 0 ;>begin name
...
CODE_008FD2:		STA !Setting_SuperStatusBar_PlayerName_XYToAddress,X	     
CODE_008FD5:		DEY	 
			DEX
			DEX	     
...
CODE_008FD8_IF_THEN:
	if !Setting_SuperStatusBar_DragonCoin_Enable != 0
...
CODE_008FE2:		STA $00		   
CODE_008FE4:		LDX #$00		
CODE_008FE6:		LDY #!Setting_SuperStatusBar_DragonCoin_Empty		
CODE_008FE8:		LDA $00		   
CODE_008FEA:		BMI CODE_008FEE	   
CODE_008FEC:		LDY #!Setting_SuperStatusBar_DragonCoin_Full		
CODE_008FEE:		TYA	       
CODE_008FEF:		STA !Setting_SuperStatusBar_DragonCoin_XYToAddress,X
CODE_008FF2:		DEC $00		   
CODE_008FF4:		INX	      
			INX	 
CODE_008FF5:		CPX #$08		
...
DATA_008FFC:		      db $A0,$86,$00,$00,$10,$27,$00,$00
	...
	if !Setting_SuperStatusBar_Score_Enable != 0 ;>begin of score 2
CODE_009012:		SEP #$20		  ; 8 bit A ; Accum (8 bit)
			LDA #$00
CODE_009014:		STA !Setting_SuperStatusBar_Score_XYToAddress,X
...
CODE_009034:		LDA !Setting_SuperStatusBar_Score_XYToAddress,X  
			INC A
			STA !Setting_SuperStatusBar_Score_XYToAddress,x
...
CODE_009051:		SEP #$20		  	; Accum (8 bit) 
			LDA #$00
CODE_009053:		STA !Setting_SuperStatusBar_BonusStars_XYToAddress,X
...
CODE_009068:		LDA !Setting_SuperStatusBar_BonusStars_XYToAddress,X   
			INC A
			STA !Setting_SuperStatusBar_BonusStars_XYToAddress,x	  
